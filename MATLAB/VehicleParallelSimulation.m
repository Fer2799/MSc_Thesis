...
% =========================
id = 1;  % Identification number of the computer
% =========================
...
run("LatinHypercubeSampling.m")  % Obtain the Latin Hypercube Samples 

model = 'FCHEV';  % Simulation model of a Fuel-Cell Hybrid Electric Vehicle
load_system(model);
